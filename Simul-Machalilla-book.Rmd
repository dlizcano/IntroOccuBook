...
link-citations: yes
linkcolor: blue
csl: C:/Users/diego.lizcano/Box Sync/CodigoR/Toshiba/IntroOccupancy/journal-of-ecology.csl
...
Este es un _libro-tutorial_ escrito con **Markdown** en [R studio](https://www.rstudio.com/), con los paquetes 'bookdown', 'knitr'y 'rmarkdown'.
...
install.packages("raster", "statspat", "jagsUI", "mcmcplots", "ggmcmc", dependencies = TRUE)
```
...
![Venado de cola blanca](C:/Users/diego.lizcano/Box Sync/CodigoR/Toshiba/IntroOccuBook/bookdown-demo-master/venado_large.jpg)
...
```{r funcall1b,eval=TRUE, warning=FALSE, echo=FALSE}
...
```{r function_ch2, warning=FALSE, echo=FALSE}
###############################
## The function starts here ###
###############################
set.seed(24) # Can choose seed of your choice
...
```{r unmarked_data,cache=TRUE,message=FALSE,eval=FALSE,echo=TRUE}
# Data generation
...
## Predicción espacialmente explícita 
...
```{r function_ch7, warning=FALSE, echo=FALSE}
###############################
## The function starts here ###
###############################
set.seed(24) # Can choose seed of your choice
...
```{r unmarked_umf1_ch7,cache=TRUE,warning=FALSE,message=FALSE, echo=FALSE}
...
```{r printestim,eval=TRUE, cache=TRUE, warning=FALSE}
